...
*Last synced: 2026-08-14 — [admin+app] Live Tracking leftover `delivery_submit` is Idle/Moving (not a green pin); In Progress = On Delivery only; OS Location off calls `driver_clear_live_location` (clock-out keeps Offline). Thank You device back → Home. Migration `20260913100000`.*
