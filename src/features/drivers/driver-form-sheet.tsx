...
import { isDriverProjectKey, type DriverProjectKey } from "@/features/fleet/fleet-labels";
...
export function DriverFormSheet({
  ...
  useEffect(() => {
    ...
    if (isEdit) {
      ...
      setSourceCompany(activeDriver.source_company ?? "");
  ...
  useEffect(() => {
    ...
    try {
      ...
      setSourceCompany(parsed.sourceCompany ?? "");
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 pt-4 pb-3">
          {isLoadingEdit ? (
            ...
            <DriverFormIdentitySection
              ...
              onSourceCompanyChange={setSourceCompany}
              ...
              labels={{
                ...
                sourceCompany: tNew("fields.sourceCompany"),
                project: tNew("fields.project"),
              ...
              projectLabels={{
                keeta: tNew("project.keeta"),
                americana: tNew("project.americana"),
                unset: tNew("project.unset"),
              }}
              placeholders={{
                ...
                sourceCompany: tNew("placeholders.sourceCompany"),
                searchSourceCompany: tNew("placeholders.searchSourceCompany"),
              }}
