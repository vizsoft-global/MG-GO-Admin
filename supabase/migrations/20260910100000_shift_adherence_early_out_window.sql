-- Early-out vs shift end is clamped to the scheduled window.
-- Clocking out before shift start used to count the pre-shift gap
-- (09:35 out vs 11:30–16:30 → 415 min). Cap at remaining shift length.
