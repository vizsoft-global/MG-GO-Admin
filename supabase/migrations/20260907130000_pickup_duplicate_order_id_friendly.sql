-- Pickup Order: a duplicate external_order_id currently bubbles the raw
-- unique-index error (`deliveries_external_order_id_unique_idx`) when
-- `driver_create_pickup` skipped its restaurant/day check (no resolved
-- restaurant_id). Catch unique_violation and re-raise duplicate_order_id.
